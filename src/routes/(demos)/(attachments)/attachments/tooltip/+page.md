...
<!-- Scroll the anchor toward either edge: `auto` re-picks a side every frame. Padding
leaves room to scroll both ways while keeping the button in view to start with. -->
<div class="demo-box" style="height: 9em; overflow: auto; margin-top: 1em">
  <div style="padding: 5em 0; display: grid; place-items: center">
    <button {@attach tooltip({ content: `I flip as you scroll` })}>
      Scroll me past the edges
    </button>
  </div>
</div>
```
